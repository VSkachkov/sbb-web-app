...
CREATE TABLE IF NOT EXISTS `SBB_DB`.`season_rates` (
  ...
  `season_rate` FLOAT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `SBB_DB`.`days_before_rate` (
  ...
  `days_before_rate` FLOAT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `SBB_DB`.`seats_left_rate` (
  ...
  `seats_left_rate` FLOAT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `SBB_DB`.`total_rate` (
  ...
  `season_rate_id` INT NOT NULL DEFAULT 1,
  `seat_left_rate_id` INT NOT NULL DEFAULT 1,
  `days_before_rate_id` INT NOT NULL DEFAULT 1,
  `age_rate_id` INT NOT NULL,
  PRIMARY KEY (`total_rate_id`),
  INDEX `season_fk_idx` (`season_rate_id` ASC),
  INDEX `days_before_fk_idx` (`days_before_rate_id` ASC),
  INDEX `seats_left_fk_idx` (`seat_left_rate_id` ASC),
...
CREATE TABLE IF NOT EXISTS `SBB_DB`.`Reserves` (
  ...
  `user_id` INT NOT NULL,
  `car_id` INT NOT NULL,
  `person_date_price_rate` FLOAT NOT NULL DEFAULT 1,
  ...
  INDEX `total_fk_idx` (`total_rate_id` ASC),
